...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	private void janelaProdutosEmLeilao(MercadoLeilao mercado) {
		...
		List<Produto> produtosEmLeilao = (List<Produto>) mercado.getProdutosEmLeilao();
		...
		Produto produtoSelecionado = (Produto)list.getSelectedValue();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void janelaProdutosVendidos(MercadoLeilao mercado) {
		...
		List<Produto> produtosVendidos = (List<Produto>) mercado.getProdutosVendidos();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void janelaProdutosVencidos(MercadoLeilao mercado) {
		...
		List<Produto> produtosVencidosENaoVendidos = (List<Produto>) mercado.getProdutosVencidosENaoVendidos();
	...
	private void janelaProdutosDeUmLeiloador(final MercadoLeilao mercado) {
		...
		comboBox.addActionListener(new ActionListener () {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				List<Produto> produtosDoLeiloador = null;
				try {
				...
				listProdutos.addListSelectionListener(new ListSelectionListener() {
					...
					public void valueChanged(ListSelectionEvent arg0) {
						Produto produtoSelecionado = (Produto)listProdutos.getSelectedValue();
