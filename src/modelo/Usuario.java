...
public class Usuario implements IUsuario, Serializable {
	...
	public void setBemComprado(Produto produto) {
	...
	public void setBemOfertado(Produto produto) {
	...
	public boolean equals(Object outroUsuario) {
		if (outroUsuario!=null && outroUsuario instanceof Usuario) {
			return this.cpf.equals(((Usuario)outroUsuario).cpf);
		}
		else{
			return false;
		}
